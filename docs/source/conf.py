...
exclude_patterns = ['_build', '_templates',
                    '**__version__.py', '**setup.py', 'api/picaxe.rst']
...
latex_documents = [
    ('index', 'picaxe.tex', u'picaxe Documentation',
     u'Dave Young', 'manual'),
]
...
man_pages = [
    ('index', 'picaxe', u'picaxe Documentation',
     [u'Dave Young'], 1)
]
...
texinfo_documents = [
    ('index', 'picaxe', u'picaxe Documentation',
     u'Dave Young', 'picaxe', 'work with the Flickr API to upload images, sort images, generate MD image reference links etc',
     'Miscellaneous'),
]
...
def generateAutosummaryIndex():
    ...
    # GET ALL SUBPACKAGES
    allSubpackages = ["picaxe"]
    allSubpackages += findAllSubpackges(
        pathToPackage="picaxe"
    )
